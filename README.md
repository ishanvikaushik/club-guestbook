...
<pre>git remote add upstream https://github.com/ishanvikaushik//club-guestbook</pre>

<li>Append your name to the contributors list in the file in the cloned repo and save the changes.
